...
export const Admit = () => {
    ...
    const reject = async(id) =>{
        try{
            await axios.put(`https://ofcourse.website/api/v2/courses/enrolling/remove`,{courseId: courseId, userId: id})
        }catch(error){
            console.log(error)
        }
    }
    const enroll = async(id) =>{
        try{
            await axios.put(`https://ofcourse.website/api/v2/courses/admit`,{courseId: courseId, userId: id})
        }catch(error){
            console.log(error)
        }
    }
